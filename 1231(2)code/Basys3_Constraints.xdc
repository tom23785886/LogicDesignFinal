...
# Switches
set_property PACKAGE_PIN V17 [get_ports {choosing}]
set_property IOSTANDARD LVCMOS33 [get_ports {choosing}]
set_property PACKAGE_PIN V16 [get_ports {auto}]
...
# set_property PACKAGE_PIN T18 [get_ports btnU]
#set_property PACKAGE_PIN W19 [get_ports isenter]
#   set_property IOSTANDARD LVCMOS33 [get_ports isenter]
